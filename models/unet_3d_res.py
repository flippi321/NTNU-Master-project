...
class ResidualUNet3D(nn.Module):
    def __init__(self, in_ch=1, out_ch=1, base=32,
        ...
        self.d2 = Down(base, base * 2).to(self.device)
        self.d3 = Down(base * 2, base * 4).to(self.device)
        self.d4 = Down(base * 4, base * 8).to(self.device)
        ...
        self.u1 = Out(base * 2, base).to(self.device)  # last layer: no upsample
